...
class ManagePostsController extends Controller{
	...
	public function save(){
             ...
             if($_POST['title'] == "")
             {
               $this->set('message', 'Title was not filled out, post discarded');
             }
             if($_POST['date'] == "")
             {
               $this->set('message', 'Date was not filled out, post discarded');
             }
             if($_POST['category'] == "")
             {
               $this->set('message', 'Category was not filled out, post discarded');
             }
             if($_POST['content'] == "")
             {
               $this->set('message', 'Content was not filled out, post discarded');
             }        
             else
             {
